...
public class DoMath {
	...
	public static void main(String[] args) {
		...
		System.out.println("The discriminant is: " + Calculate.discriminant(59, 71, 77));
		...
		System.out.println("Num0 is evenly divided by num1: " + Calculate.isDivisibleBy(7, 3));
		System.out.println("The absolute value is: " + Calculate.absValue(-8));
		System.out.println("The max of the 2 values is: " + Calculate.max(2, -1));
		System.out.println("The max of the 3 values is: " + Calculate.max(0, -10, 8));
		System.out.println("The min of the 2 values is: " + Calculate.min(-3, 2));
		System.out.println("The value rounded to 2 decimal points is: " + Calculate.round2(2.8839));
		System.out.println("Base raised to exponent is: " + Calculate.exponent(5, 2));
		...
		System.out.println("The gcf of the values is: " + Calculate.gcf(25, 100));
		System.out.println("The sqrt of the value is: " + Calculate.sqrt(65));
	}
